            ...
            <div class="col-9">
                    <div class="mb-3">
                      ...
                      <div class="mb-3">
                        ...
                        <textarea name="short_description" id="shortDescriptionEditor">
                        ...
                        <ul class="list-group border rounded" style="max-height: 200px; overflow-y:scroll;">
                            ...
                            <li class="list-group-item">
                              ...
                              <div class="form-check">
                                  <input class="form-check-input" type="checkbox" value="{{ $category->id }}" name="categories[]" id="categoryID" {{ $product->categories->filter( function($item) use($category){return $item->id ==  $category->id; })->isNotEmpty() ? 'checked' : '' }}>
...
<script>
  tinymce.init({
    selector: 'textarea#shortDescriptionEditor', // Replace this CSS selector to match the placeholder element for TinyMCE
...
<script>
  tinymce.init({
    selector: 'textarea#descriptionEditor', // Replace this CSS selector to match the placeholder element for TinyMCE
    plugins: 'code table lists image',
    toolbar: 'undo redo | blocks | bold italic | alignleft aligncenter alignright | indent outdent | bullist numlist | code | table | image'
  });
</script>
